...
var css$4 = "svg{width:min-content;height:100%}line{stroke-width:1;stroke:#3c3c3c}#wave{stroke-width:4;stroke-linecap:round;stroke-linejoin:round;stroke:#56acf4}#wave,#wave2{fill:none;transition:.5s}#wave2{stroke-width:4;stroke-linecap:round;stroke-linejoin:round;stroke:#f4566b}.full{position:absolute;margin:auto;top:0;bottom:0;left:0;right:0;display:flex;justify-content:center;align-items:center;background-color:hsla(0,0%,50.2%,.33);z-index:999}";

class PenLoading extends PenBase {
  static get styles() {
    return [css$4];
  }
  static get boundAttributes() {
...
var css$5 = "#container .label-div{display:flex;justify-content:space-between;padding:var(--small-padding,4px)}";
